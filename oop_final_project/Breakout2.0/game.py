...
class Game:
    ...
    def create_bricks(self, layout_type):
        ...
        self.bricks.clear()
        if layout_type == 'default':
            self.bricks = Layouts.layout_default(self.screen.get_width(), self.layout_offset_x)
        elif layout_type == 'cross':
            self.bricks = Layouts.layout_cross(self.screen.get_width(), self.layout_offset_x)
        elif layout_type == 'zigzag':
            self.bricks = Layouts.layout_zigzag(self.screen.get_width(), self.layout_offset_x)
        else:
            self.bricks = Layouts.layout_default(self.screen.get_width(), self.layout_offset_x)
    ...
    def show_welcome_screen(self):
        ...
        options = [
            ...
            {"text": "Cross Layout", "action": "cross"},
    ...
    def draw(self):
        ...
        for extra_ball in self.extra_balls:
            pygame.draw.circle(self.screen, extra_ball["color"],
                               extra_ball["rect"].center, BALL_RADIUS)
